export default function GridBackground() {
  return (
    <div className="fixed left-0 top-0 -z-50 h-full w-full bg-white">
      ...
      <div className="absolute h-full w-full bg-[linear-gradient(to_right,#f8e7bf_1px,transparent_1px),linear-gradient(to_bottom,#f8e7bf_1px,transparent_1px)] bg-size-[50px_50px]"></div>
